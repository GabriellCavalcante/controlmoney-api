...
import com.example.controlmoneyapi.model.Lancamento_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<Lancamento> query, Pageable pageable) {
		...
		int primeirosRegistrosDaPagina = paginaAtual * totalRegistrosPorPagina;
		
		query.setFirstResult(primeirosRegistrosDaPagina);
